...
var yamlPath = java.lang.System.getenv("YAML_PATH")
if (yamlPath == null || yamlPath == '') {
  console.error('YAML_PATH ENV variable is null or a empty string. Falling back to default-config.yaml')
...
if (_.isInteger(yamlPathScanPeriod) == false) {
  console.error('YAML_PATH_SCAN_PERIOD ENV variable is null or is not an integer. Falling back to value: 5000')
  yamlPathScanPeriod = 5000
}
